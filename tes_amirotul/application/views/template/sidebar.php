					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-10 pt-2" id="kt_app_sidebar_logo">
							...
							<a href="<?php echo site_url('home_c');?>">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
								<img alt="Logo" src="<?php echo base_url('assets/media/framework-logos/codeigniter.PNG');?>" class="h-25px app-sidebar-logo-default" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<div class="fw-bold fs-6 text-center"><font color="white">TES PROGRAMMER</font></div>
								<img alt="Logo" src="<?php echo base_url('assets/media/framework-logos/codeigniter.PNG');?>" class="h-20px app-sidebar-logo-minimize" />
							</a>
							<!--end::Logo image-->
						...
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
							...
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div class="menu-item">
										<!--begin:Menu link-->
										<a class="menu-link" href="<?php echo site_url('produk');?>">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="<?php echo site_url('kategori');?>">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="<?php echo site_url('status');?>">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
